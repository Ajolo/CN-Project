...
def draw_menu(stdscr):
    ...
    # subwindow for text input -- limit to 36 to avoid spillover
    inputWindow = stdscr.subwin(1, 36, height-2, 0)
    ...
    try: 
        ...
        center_x_title = int((width // 2) - (len(title) // 2) - len(title) % 2 + 7)
        ...
        # Render moneybag
        stdscr.addstr(center_y-4, (width // 2) + 5, '-' * 5)            # -2
        stdscr.addstr(center_y-3, (width // 2) + 5, "\\   /")           # -2
        stdscr.addstr(center_y-2, (width // 2) + 6, "***")              # -1 
            ...
            while 1: 
                ...
                for sockets in read_sockets: 
                    if sockets == server: 
                        ...
                        # check if /clear was sent, handle client side
                        if message == '/clear':
                            for _ in range(30):
                                text_to_render.insert(0, ' ')
                        else:
